...
<script>
$(".menu ul li:nth-child(1)").addClass("currentPage");
</script>
  <!-- Caja de titulo -->
...
<<<<<<< HEAD
  ...
  <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 center-to-parent">
=======
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  container container-servicios">
  <!-- Bloque uno-->
