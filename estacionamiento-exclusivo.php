...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  title-serv">
  <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 box-icon">
          <img src="img/icono-estacionamiento.svg" alt="" />
        </div>

        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 triangle">
          <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 card-logo-1">  </div>
        </div>
  </div>


<div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 center-to-parent ">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  container-sub container-estacionamiento">
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 marco-text " hid="1">
    <h1> ESTACIONAMIENTO PREFERENCIAL Y ÁREA DE CARGA EXCLUSIVA</h1>
    <p>Estacioná tu vehículo en los sectores preferenciales, para que faciliten la velocidad de carga. Para
      <span>ahorrar tiempo</span>
        y hacer tu visita a Makro mucho más eficiente.
    </p>
</div>
